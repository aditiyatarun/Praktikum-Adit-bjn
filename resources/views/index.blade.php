...
<head>
    ...
    <title>BS Clone</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
    <!-- Option 1: Include in HTML -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.3.0/font/bootstrap-icons.css">
    @vite('resources/views/tugas1/Assets/css/style.css')
</head>

<body>
    <!-- Navbar -->
    <nav class="navbar navbar-dark fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        <!-- Container -->
        <div class="container py-2 px-4">
            <!-- Navbar Brand -->
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="{{ Vite::asset('resources/views/tugas1/Assets/image/BS_Logo.png') }}"
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><button class="dropdown-item active bg-purple" type="button"><small><i
                                                    class="bi-brightness-high-fill me-2">Light</i></small></button>
                                    </li>
                                    <li><button class="dropdown-item" type="button"><small><i
                                                    class="bi-moon-stars-fill me-2">Dark</i></small></button></li>
                                    <li><button class="dropdown-item" type="button"><small><i
                                                    class="circle-half me-2">Auto</i></small></button></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-5">
                    <img class="img-fluid" src="{{ Vite::asset('resources/views/tugas1/Assets/image/main.svg') }}"
                        alt="main logo">
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5"><a href="#">Bootstrap Icons</a> is an open source SVG icon library
                        featuring pver 1,800 glyphs, with more added every release. They're designed to work in any
                        project, whether you use Bootstrap itself or not. Use them as SVGs or icon fonts--both option
                        give you vector scaling and easy customization via CSS</p>
                    <a href="#" class="icon-link icon-link-hover lead fw-semibold mb-5">Get Bootstrap Icons<i
                            class="bi bi-arrow-right mb-2"></i></a>
                </div>
                <div class="col-lg-6">
                    <img src="{{ Vite::asset('resources/views/tugas1/Assets/image/bs-icons.png') }}"
                        alt="Bootstrap Icons" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level witih premium themes from <a
                            href="#">official Bootstrap Themes marketplace</a>. Themes are built on Bootstrap as
                        their own extended frameworks, rich with new components and plugins, documentation, and powerful
                        build tools.</p>
                    <a href="#" class="icon-link icon-link-hover lead fw-semibold mb-5">Browse Bootstrap
                        Themes<i class="bi bi-arrow-right mb-2"></i></a>
                </div>
                <div class="col-lg-6">
                    <img src="{{ Vite::asset('resources/views/tugas1/Assets/image/bs-themes.png') }}"
                        alt="Bootstrap Themes" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img src="{{ Vite::asset('resources/views/tugas1/Assets/image/logo-black.svg') }}"
                                alt="Bootstrap Logo" class="img-fluid" style="width: 40px;">
                            <div class="fs-5 ms-2 text-black">Bootstrap</div>
                        </div>
                    </a>
                    <div class="mt-2 text-muted">
                        <small>Designed and built with all the in the world by the <a href="#"
